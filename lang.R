kLang <- list(
  EN = list(
    ...
    profile.row4         = "Children between 10 and 24 months",
    profile.row5         = "NON eligible children",
    profile.row6         = "Eligible children",
    profile.row7         = "Eligible children selected",
    profile.row8         = "Children/caretakers interviewed",
    profile.row9         = "Children/caretakers that interrupted interview",
    profile.row10        = "Children NON interviewed",
    ...
    profile.check2       = "Children must be equal to the sum of eligibles + NON eligibles",
    profile.check3       = "NON interviewed children must be equal to the sum of denied + absent + unabled",
    profile.check4       = "Children selected must be equal to the sum of interviewed + interrupted + NON interviewed",
    ...
    profile.note1        = "Eligible children: children that meets selection is between 10 and 24 months and is not participating has participated in ICARIA trial",
