kLang <- list(
  EN = list(
    ...
    profile.row4         = "Children between 10 and 23 months",
    profile.row5         = "NON eligible children",
    profile.row6         = "Eligible children",
    profile.row7         = "Eligible children selected",
    profile.row8         = "Caretakers interviewed",
    profile.row9	 = "Children with performed RDT",
    profile.row10	 = "Children with RDT positive",
    profile.row11        = "Caretakers that interrupted interview",
    profile.row12        = "Caretakers NON interviewed",
    profile.row13        = "Denied signed consent/assent",
    profile.row14        = "Absent",
    profile.row15        = "Not able to respond",
    profile.row16        = "Other reason",
    profile.row17        = "HH selected NOT interviewed",
    profile.row18        = "Empty/destroyed",
    profile.row19        = "HH head not found",
    profile.row20        = "HH head/other refused to consent the interview",
