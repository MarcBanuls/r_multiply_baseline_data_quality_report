...
# File
file_prefix = ""
file_content = "MULTIPLYHHSBaselineS_DATA_"
file_date   ="2021-11-26"
file_time   ="15:51"

# Study area description
study_area_id           = 3
country_name            = "Sierra Leone"
study_area_label        = "Tonkolili"
study_area_column       = "tonkolili"
sample_size             = 710
partner.name            = "template"
# sample_size * 5 (5 households to find one eligible children)
household_to_be_visited = 3550
...
# Remove the variables for each df that are empty (and arm name to avoid interferences)
hhs <- hhs[,-c(2,188:220)]
rdt <- rdt[,-c(2:187)]
...
#for only reports from file where first column has ï..:
names(hhs)[names(hhs) == 'ï..record_id'] <- 'record_id'
names(rdt)[names(rdt) == 'ï..record_id'] <- 'record_id'
...
`r language$progress.partner` [`r partner.name`]().
