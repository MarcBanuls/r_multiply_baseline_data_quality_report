...
source("multiply_hhs_quality_moz.R")
source("lang.R")
source("tokens.R")
...
# hhs_data = data
# 
# #change "cluster" name to "cluster_massinga" to facilitate change of code
# names(hhs_data)[names(hhs_data) == 'cluster'] <- 'cluster_massinga'
# 
# # Global variables
...
```{r, joinclusterstomassinga, echo=FALSE }
hhs_data$cluster_massinga[!is.na(hhs_data$locality)] = 
...
```{r duplicated_records, echo=FALSE, warning=FALSE}
