...
```{r, echo=FALSE}
# Issue to be solved
# Created yes/no variables to use in the consentment and childbirth date checks
...
hhs_data$child_birth_q[hhs_data$diff_in_months > 10] = 0
hhs_data$child_birth_q[hhs_data$diff_in_months < 24] = 1
